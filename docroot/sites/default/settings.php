 ...
 * @endcode
 */
$settings['hash_salt'] = 'a2JrDqIfafLXYJdG0DEAyx53kzqC8ZReNQtTJfKQO3qZFJTogK4YdZO';
 ...
 */
if ($is_local_env) {
  if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_data_dd.inc')) {
    require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_data_dd.inc';
  }
